...
export default function SubscribeForm() {
  ...
  const [message, setMessage] = useState(
    <div>
      ...
      <a href="https://whynesspower.substack.com/archive" target="_blank">
        (See previous issues)
      </a>
    </div>
  );
  ...
  const submit = async () => {
    ...
    try {
      await fetch("https://sub..workers.dev", {
        method: "POST",
      ...
      setMessage(
        <span>
          ...
          <a target="_blank" href="https://whynesspower.substack.com/">
            https://whynesspower.substack.com/
          </a>
          . Sorry! 😢
        </span>
      );
